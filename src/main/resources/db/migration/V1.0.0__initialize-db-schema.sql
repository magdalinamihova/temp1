    ...
    create table books (
        ...
        book_status varchar(3) CHECK(book_status in ('AVL','BRW','MBR')),
        filetype varchar(255),
        language varchar(2) CHECK(language in ('EN','DE','FR','ES','IT','PT','NL','RU','PL','SV','NO','DA','FI','EL','CS','HU','RO','BG','SR','HR','BS','SK','SL')),
        primary key (id)
    );
    ...
    create table users (
        ...
        country varchar(255),
        filetype varchar(255),
        gender varchar(1) CHECK(gender in ('f','m','o','u')),
        phone_number varchar(255),
        postal_code varchar(255),
        street varchar(255),
        user_role varchar(1) CHECK(user_role in ('A','S')),
        primary key (id)
    );
